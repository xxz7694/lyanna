        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label-width="45px" label="作者:" class="postInfo-container-item">
              <el-select v-model="postForm.author_id" :remote-method="getRemoteUserList" remote filterable placeholder="搜索用户">
                <el-option v-for="item in userListOptions" :key="item.id+item.name" :label="item.name" :value="item.id"/>
              </el-select>
            </el-form-item>
          </el-col>
