    ...
    <el-form ref="topicForm" :model="topicForm" :rules="rules" class="form-container">
      ...
      <div class="createTopic-main-container">
        <el-row>
          <el-col :span="24">
            <el-form-item style="margin-bottom: 40px;" prop="title">
              <MDinput v-model="topicForm.title" :maxlength="100" name="title" required :disabled="isEdit">
                Title
              </MDinput>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item style="margin-bottom: 20px;" prop="slug">
              <MDinput v-model="topicForm.slug" :maxlength="100" name="slug" required>
                Slug
              </MDinput>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item style="margin-bottom: 40px;" prop="intro">
              <MDinput v-model="topicForm.intro" :maxlength="100" name="intro" required>
                Intro
              </MDinput>
            </el-form-item>
          </el-col>
        ...
        <div class="post-container">
          <dnd-list :list1="topicForm.posts" :list2="allPosts" list1-title="PostList" list2-title="Article pool" />
        </div>
      </div>
    </el-form>
